...
4. Once all issues are resolved, produce:
   - `ai/PRD.jsonc` matching the schema and tailored to the plan.
   - `ai/PROMPT.md` tailored to the plan and aligned with the PRD.
